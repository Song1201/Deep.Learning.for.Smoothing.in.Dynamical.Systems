...
xTest = np.load('generateData/LG200xTest.dat')
zTest = np.load('generateData/LG200zTest.dat')

zTry = np.load('generateData/LG200xTrain.dat')
xTry = np.load('generateData/LG200zTrain.dat')
